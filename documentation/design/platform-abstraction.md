...
| Motor driver role         | The two motor bridges, plus notification when the driver faults  | Coast reachable without a healthy control loop; a fault is reported, never polled   |
